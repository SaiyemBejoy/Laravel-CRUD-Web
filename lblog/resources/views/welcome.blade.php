...
@section('content')
    ...
    <br><h1 class="text-center">Home Page</h1>
		    ...
		    <tr>
		      ...
		      <td>
		      	...
		      	||
		      		...
		      		<button onclick="if(confirm('Are you sure that you want to delete this data?')) {
		      			event.preventDefault();
		      			document.getElementById('delete-form-{{ $student->id }}').submit();
		      		}else{
		      			event.preventDefault();
		      		}" 
		      		class="btn btn-raised btn-danger btn-sm" href="{{route('delete', $student->id)}}">
